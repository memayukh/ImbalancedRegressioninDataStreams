...
! fphion for a set of points of the target variable provided.
!----------------------------------------------------------------
...
!----------------------------------------------------------------
! References:: Ribeiro, R., 2011. PhiRelevance-based regression
...
!----------------------------------------------------------------
	...
	real(kind=8), intent (inout) :: yPhi(n)
	real(kind=8), intent (inout) :: ydPhi(n)
	real(kind=8), intent (inout) :: yddPhi(n)
	!Local Variables
...
!              and
!              Ribeiro, R., 2011. PhiRelevance-based regression
!              (Doctoral dissertation, PhD thesis,
!              Dep. Computer Science, Faculty of Sciences
!              University of Porto).
!----------------------------------------------------------------
